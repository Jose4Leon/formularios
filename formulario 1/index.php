...
<section class="get-in-touch">
   ...
   <form class="contact-form row" action="https://formsubmit.co/killandyou123@gmail.com" method="post">
      ...
      <input type="hidden" name="_next" value="https://formu.jose.corpipsa.com/fomulario1">
